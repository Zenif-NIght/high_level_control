...
TopologyGoalGenerator::TopologyGoalGenerator(const std::string & frame_id, const std::string & odom_base, const std::string & goal_base,
                                             const std::string & topic_base, double dist_to_change):
frame_id(frame_id), odom_base(odom_base), topic_base(topic_base), goal_base(goal_base), graph(frame_id), dist_to_change(dist_to_change)
{
